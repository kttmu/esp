...
#added module for saving module
def save_model():
    return
...
def main(_):
    ...
    #src2 = input()
    x = tf.compat.v1.placeholder(tf.float32, shape=[None, height, width, 3])
    y = tf.compat.v1.placeholder(tf.int32, shape=[None, height, width])
